...
const variantStyles = {
  solid: {
    ...
    lime: 'bg-lime-600 text-white hover:bg-lime-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600 active:bg-lime-700 active:text-white/80 disabled:opacity-30 disabled:hover:bg-lime-600',
    white:
  ...
  outline: {
    ...
    lime: 'border-lime-300 text-lime-600 hover:border-lime-400 hover:bg-lime-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600 active:text-lime-600/70 disabled:opacity-40 disabled:hover:border-lime-300 disabled:hover:bg-transparent',
  },
}
